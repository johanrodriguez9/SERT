            ...
            <div class="rs-shop pt-100 pb-100 md-pt-80 md-pb-80">
                <div class="container">
                    <div class="row">
                        ...
                        <?php foreach ($listar_tienda_categoria as $value): ?>
                                <div class="col-lg-4 col-sm-6 mb-73 md-mb-43">
                                    <div class="product-list">
                                        <div class="image-product">
                                            <img src="<?= base_url();?>assets/img_tienda/<?php echo $value->tienda_imagen ?>" alt="">
                                            <div class="overley">
                                                <a href="<?= base_url(Hasher::make(190,$value->tienda_id)); ?>"><i class="flaticon-shopping-bag"></i></a>
                                            </div>
                                        </div>
                                        <div class="content-desc text-center">
                                            <h2 class="loop-product-title pt-19"><a href="<?= base_url(Hasher::make(190,$value->tienda_id)); ?>"><?php echo $value->tienda_titulo ?></a></h2>
                                            <span class="price"><del><?php echo $value->tienda_costo ?> $ </del><?php echo $value->tienda_oferta_costo ?> $ </span>
                                        </div>
                                    </div>
                                </div>
                        <?php endforeach ?>
