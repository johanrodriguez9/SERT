...
<head>
 ...
 <!-- Agrega tu código desde aquí -->
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="main-signin-header">
                                    <h2>REENVIAR CODIDO DE VERIFICACION EMAIL</h2>
                                    <form method="post" id="session_system_1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input onkeyup="buscar_email(this.value)" id="app-email-confirm" type="email" class="form-control" maxlength="50" name="emailrtxt" placeholder="Ingrese su email" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 app-enviar">
                                                <button type="submit" class="btn btn-main-primary btn-block">ENVIAR</button>
                                            </div>
                                        </div>
    ...
    $("#session_system_1").submit(function(event) {
        ...
        $.ajax({
            url:'<?= site_url(Hasher::make(250)); ?>',
            type:'POST',
            data:$("form").serialize(),
            success:function(dato){ 
                $("#ver_mensaje").html(dato);
                swal("NOTA!", "REENVIO DE CODIGO VERIFICACIÓN EMAIL EXITOSO", "success")
                setTimeout(function(){
    ...
    function buscar_email(ci) {
        $.post('<?php echo base_url();?>Registrarusuario/reenvia_buscar_email', {ci}, function(data) {
