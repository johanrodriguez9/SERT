...
class MY_Controller extends CI_Controller
{
	...
	public function __construct()
	{
		...
		//nombre de sistema
		$this->data['sistema'] = $this->config->item('dp_sistema');
...
class Authenticate extends MY_Controller
{
	public function __construct()
	{
		...
		// Title
		$this->data['title'] = ( ! empty($this->config->item('dp_title'))) ? $this->config->item('dp_title') : 'Sistema de inscripciones  SUYAy-main';
	}
...
class Backend extends MY_Controller
{
	public function __construct()
	{
		...
		else
		{
			...
			//control por grupo regis
			/* if (!$this->ion_auth->in_group('planilla')) {
                //redirect('auth/logout', 'refresh');
            }*/
            //control de carrera 
            $dato=$this->ion_auth->user()->row();
	        if(empty($dato->carrera_id))  redirect('auth/logout', 'refresh');
			...
			//$this->data['usuario'] = $user->first_name . ' ' . $user->last_name;
	...
	public function render()
	{
		 ...
		 //control de carrera 
            //$dato=$this->ion_auth->user()->row();
	        //if(!empty($dato->carrera_id))  redirect('auth/login', 'refresh');
...
class Frontend extends MY_Controller
{
	public function __construct()
	{
		...
		// Title
		$this->data['title'] = ( ! empty($this->config->item('dp_title'))) ? $this->config->item('dp_title') : 'Inscripciones';
	}
