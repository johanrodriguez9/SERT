...
*/
$config['tables']['users']           = 'dp_auth_users';
$config['tables']['groups']          = 'dp_auth_groups';
$config['tables']['users_groups']    = 'dp_auth_users_groups';
$config['tables']['login_attempts']  = 'dp_auth_login_attempts';
 ...
 */
$config['site_title']                 = "regis envia";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['default_group1']             = 'estudiante';           // Default group, use name
$config['default_group2']             = 'docente';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['admin_group']                = 'kardixta';             // Default administrators group, use name
