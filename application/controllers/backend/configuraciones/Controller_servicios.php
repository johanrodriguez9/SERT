...
class Controller_servicios extends Backend
{
	...
	public function index()
	{
		...
		{ 
			...
			$tabla='tech_servicio';
			$query='1 ORDER BY servicio_id DESC';
			$this->data['listar_servicios']=$this->Modelo_configuracion->consult($tabla,$query);
			$this->data['page_content'] = 'backend/configuraciones/vista_servicios/servicio_index';
			$this->render();
		}
	}
	public function adicionar(){
			...
			if ($imagen==null) {
				...
				if ($_FILES['imagen']['type']=="image/jpg" || $_FILES['imagen']['type']=="image/jpeg") {
					...
					$ruta="assets/img_servicios/serv_".$ima;
				...
				$mensaje = strtr(rawurlencode($mensaje), $revert);
				$enlace = "https://api.whatsapp.com/send?phone=591".$numero."&text=".$mensaje;

				echo $enlace;
				 //  <a href=" echo $enlace ">Compartir</a> 
				$obj=array(
				'servicio_titulo'=>$titulo,
				'servicio_referencia'=>$enlace,
				'servicio_estado'=>1,
				'servicio_imagen'=>$imag,
				'servicio_numero'=>$numero,
				'servicio_mensaje'=>$mensaje,
    ...
    public function vista_servicios_backend(){        
        $tabla='tech_servicio';
			$query='1 ORDER BY servicio_id DESC';
			$this->data['listar_servicios']=$this->Modelo_configuracion->consult($tabla,$query);
    
        $this->data['page_content'] = 'backend/configuraciones/vista_servicios/vista_servicios_backend';
        $this->render();
    }
